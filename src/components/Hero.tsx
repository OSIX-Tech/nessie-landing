...
function Hero() {
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen w-full flex items-center overflow-hidden py-20">
      {/* Background gradient orbs - full width */}
      <div className="absolute inset-0 w-full">
        <div className="absolute top-1/4 -left-1/4 w-[800px] h-[800px] rounded-full opacity-[0.15]"
             style={{ 
               background: 'radial-gradient(circle, rgb(var(--color-gray-400)) 0%, transparent 60%)',
               filter: 'blur(80px)'
             }} />
        <div className="absolute bottom-0 -right-1/4 w-[1000px] h-[1000px] rounded-full opacity-[0.08]"
             style={{ 
      ...
      <div className="relative w-full px-6 md:px-12 lg:px-24">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              {/* Main headline */}
              <h1 className="heading-xl animate-on-load opacity-0 mb-6 -mt-8" 
              ...
              {/* Subheadline */}
              <p className="text-xl md:text-2xl animate-on-load opacity-0 mb-10 max-w-xl leading-relaxed"
              ...
              {/* CTA Buttons */}
              <div className="flex flex-col sm:flex-row gap-4 animate-on-load opacity-0">
                <a href="#" 
                   className="group btn-primary inline-flex items-center justify-center px-8 py-4 text-base">
                ...
                <a href="#" 
                   className="btn-secondary inline-flex items-center justify-center px-8 py-4 text-base group">
            ...
            <div className="relative h-[600px] hidden lg:flex items-center justify-center">
              <div className="relative w-full max-w-[600px] h-full">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[450px] h-[450px]"
                  ...
                  <div className="absolute left-0 top-1/2 -translate-y-1/2 w-3 h-3 rounded-full"
