      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-24 py-12 md:py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="mb-4">
              <h3 className="text-2xl font-bold" style={{ color: 'rgb(var(--color-black))' }}>
                Nessie
              </h3>
              <p className="text-sm mt-2" style={{ color: 'rgb(var(--color-gray-600))' }}>
                Tu conocimiento empresarial, reinventado con IA.
              </p>
            </div>
            <div className="flex gap-4">
              {/* Social links */}
              <a href="#" aria-label="LinkedIn" className="text-gray-500 hover:text-black transition-colors">
              ...
              <a href="#" aria-label="GitHub" className="text-gray-500 hover:text-black transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Product column */}
          <div>
            <h4 className="font-semibold mb-4" style={{ color: 'rgb(var(--color-black))' }}>
              Producto
            </h4>
        ...
        {/* Bottom bar */}
        <div className="pt-8 border-t" style={{ borderColor: 'rgb(var(--color-gray-200))' }}>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-xs text-center md:text-left" style={{ color: 'rgb(var(--color-gray-500))' }}>
