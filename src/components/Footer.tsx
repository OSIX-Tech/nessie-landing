function Footer() {
  ...
  return (
    <footer className="relative border-t" style={{
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-12 lg:px-24 py-8 sm:py-12">
        {/* Simplified footer with social links and legal links */}
        <div className="flex flex-col items-center gap-6">
          {/* Social links with improved contrast */}
          <div className="flex gap-4">
            <a href="#" aria-label="LinkedIn"
               className="text-gray-400 hover:text-white transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-white/40 rounded-lg p-1">
